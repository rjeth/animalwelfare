                            ...
                            <form method="post" action="update_settings.php" enctype="multipart/form-data">
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="image_file" id="image_file" aria-describedby="fileInput">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" id="bios" name="bios" rows="5"><?php echo $record['bio']; ?></textarea>
                                </div>
                                <hr class="mt-10">
                                <div class="form-group">
