                    ...
                    <div class="card mb-4 wow fadeIn">
                        <div class="card-header font-weight-bold">
                            <h3 style="float:left" class="modal-title"><span class="badge red">
                                    <?php echo $record['pet_status']; ?></span></h3>
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
                                                <button type="button" class="dropdown-item" data-toggle="modal"
                                                    data-target="#edit_pet" id="<?php echo $record['pet_id'] ?>">
                                                    Edit
                                                </button>
                                                <button type="button" class="dropdown-item" id="<?php echo $record['pet_id'] ?>">
                                                    delete
                                                </button>
                                            </div>
                                        </li>
