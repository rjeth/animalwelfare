              ...
              if($_GET['pet_id']) {
                  ...
                  ?>
                    <div class="card col-md-8 mx-auto wow fadeIn ">
                        <img src="../home/upload/<?php echo $data['pet_image']; ?>" class="card-img-top" alt="Card image cap">
                        <div class="card-body">
                          ...
                          <div class="form-group">
                            <p class="mt-0 text-muted" for="location">Age</p>

                            <label id="location">
                                <?php echo $data['pet_yr']; ?>yr ,   <?php echo $data['pet_month']; ?>month </label>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                        <?php  echo "<a class='btn btn-primary' href='../inbox/create_message.php?pet_id=".$data['pet_id']."'>Send Message to Pet owner</a>" ?>
                          </div>
